...
urlpatterns = [
    ...
    path('delete/photos/<int:photo_id>/', DeletePhoto.as_view(), name='delete_photo'),
    ...
    path('memories/photos/<int:memory_id>/', MemoryPhotosView.as_view(), name='memory_photos'),
    ...
    path('memories/approve/<int:memory_id>/', ApproveMemory.as_view(), name='approve_process'),
    path('memories/deletephotos/<int:photo_id>/', MemoryPhotoDelete.as_view(), name='delete_memory_photo'),
    path('memories/deletetags/<int:tag_id>/', MemoryTagDelete.as_view(), name='delete_memory_tag'),
